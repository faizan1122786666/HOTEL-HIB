            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2 bg-blue-50 p-4 rounded-lg">
                  <h3 className="font-semibold text-blue-900 mb-4">🏨 Hotel Information</h3>
          ...
          <div className="overflow-x-auto bg-white rounded-lg shadow">
            <table className="w-full">
              <thead>
                <tr className="border-b-2 border-gray-200 bg-gray-50">
                  <th className="text-left py-4 px-4 font-semibold text-gray-900">Name</th>
                  <th className="text-left py-4 px-4 font-semibold text-gray-900">Hotel</th>
                  <th className="text-left py-4 px-4 font-semibold text-gray-900">City</th>
                  <th className="text-left py-4 px-4 font-semibold text-gray-900">Floor</th>
                  <th className="text-left py-4 px-4 font-semibold text-gray-900">Type</th>
                  <th className="text-left py-4 px-4 font-semibold text-gray-900">Price</th>
                  <th className="text-left py-4 px-4 font-semibold text-gray-900">Occupancy</th>
                  <th className="text-left py-4 px-4 font-semibold text-gray-900">Status</th>
              ...
              <tbody>
                {rooms.map((room) => (
                  <tr key={room._id} className="border-b border-gray-200 hover:bg-gray-50 transition">
                    ...
                    <td className="py-4 px-4 text-gray-900 font-medium">{room.hotelName}</td>
                    <td className="py-4 px-4 text-gray-600">{room.city}</td>
                    <td className="py-4 px-4 text-gray-600">Floor {room.floor}</td>
                    <td className="py-4 px-4 text-gray-600">
                      {room.type.charAt(0).toUpperCase() + room.type.slice(1)}
                    </td>
                    <td className="py-4 px-4 text-gray-900">
