      ...
      <div className={`bg-white rounded-3xl shadow-2xl w-full max-w-2xl mx-4 transform transition-all duration-500 overflow-hidden max-h-[90vh] overflow-y-auto ${isAnimating ? 'scale-100 opacity-100' : 'scale-95 opacity-0'}`}>
        ...
        <div className="px-8 py-8 space-y-8 print:px-4 print:py-4 print:space-y-4">
          ...
          <div className="flex justify-between items-start">
            ...
            <div className="text-right">
              <p className="text-3xl font-bold text-slate-900">Rs {payment?.amount?.toLocaleString('en-PK')}</p>
              <p className="text-xs text-slate-500 mt-1">
                {new Date(booking?.createdAt).toLocaleDateString('en-US', { 
                  year: 'numeric', 
                  month: 'short', 
          ...
          <div className="space-y-4 print:hidden">
            ...
            <div className="bg-gradient-to-br from-blue-50 to-indigo-50 p-6 rounded-2xl border border-blue-200">
              ...
              <div className="flex justify-between items-start">
                ...
                <div className="text-right">
                  <p className="text-xs text-slate-600">Per night</p>
                  <p className="text-xl font-semibold text-blue-600">Rs {(booking?.totalPrice / nights).toLocaleString('en-PK')}</p>
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="hidden print:block bg-slate-50 p-4 rounded-xl">
            <p className="text-xs font-semibold text-slate-500 uppercase tracking-wide mb-2">Accommodation</p>
            <p className="text-sm font-semibold text-slate-900">{booking?.roomName} • {nights} nights @ Rs {(booking?.totalPrice / nights).toLocaleString('en-PK')}/night</p>
          </div>
          ...
          <div className="space-y-3 print:space-y-1">
            <div className="flex justify-between text-sm">
              <span className="text-slate-600">Subtotal ({nights} nights)</span>
              <span className="font-semibold text-slate-900">Rs {booking?.totalPrice.toLocaleString('en-PK')}</span>
            </div>
            <div className="flex justify-between text-sm">
              <span className="text-slate-600">Taxes & fees (10%)</span>
              <span className="font-semibold text-slate-900">Rs {(booking?.totalPrice * 0.1).toLocaleString('en-PK')}</span>
            </div>
            <div className="h-px bg-slate-100"></div>
            <div className="flex justify-between items-center">
              <span className="font-semibold text-slate-900">Total</span>
              <span className="text-2xl font-semibold text-slate-900">Rs {payment?.amount?.toLocaleString('en-PK')}</span>
            </div>
          </div>
